...
var file_bandcampserver_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_bandcampserver_proto_goTypes = []interface{}{
	...
	(*proto1.Item)(nil),        // 6: bandcamplib.Item
}
var file_bandcampserver_proto_depIdxs = []int32{
	6, // 0: bandcampserver.Config.items:type_name -> bandcamplib.Item
	...
	3, // 3: bandcampserver.BandcampServerService.AddMapping:input_type -> bandcampserver.AddMappingRequest
	2, // 4: bandcampserver.BandcampServerService.SetToken:output_type -> bandcampserver.SetTokenResponse
	4, // 5: bandcampserver.BandcampServerService.AddMapping:output_type -> bandcampserver.AddMappingResponse
